...
(function (Baum) {
    ...
    function generateForm() {
        ...
        for (var i = 0; i < Baum.config.groups.length; i++) {
            ...
            else if (group.type == Baum.textInput) {
        ...
        for (i = 0; i < Baum.config.deliveryTypes.length; i++) {
            var deliveryType = Baum.config.deliveryTypes[i];
